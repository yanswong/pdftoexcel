    ...
    <div style="text-align: center"><table border="0" cellpadding="0" cellspacing="0" width="700px" >
        <tbody>
            ...
            <tr style="font-style: italic; font-family: Verdana">
                ...
                <td style="height: 160px; width: 583px;">
                    ...
                    <p style="text-align: justify">
                        <span><span class="blue12"><span style="font-size: 10pt">This sample shows how to extract
                            Text from PDF document in memory.</span></span></span></p>
                </td>
            </tr>
            <tr>
                <td style="width: 75px">
                    &nbsp;</td>
                <td style="text-align: right; width: 583px;">
            ...
            <tr>
                <td colspan="2" style="height: 51px;">
                        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Extract Text" />
                    <br />
                    <asp:TextBox ID="TextBox1" runat="server" Height="600px" TextMode="MultiLine" Width="800px"></asp:TextBox></td>
            </tr>
        </tbody>
    </table>
        <br />
